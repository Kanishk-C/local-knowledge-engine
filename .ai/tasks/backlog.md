...
**Task T1.1.1: Markdown & Obsidian Parsers** (COMPLETE)
...
**Task T1.2.1: Ollama Provider & Capability Detection** (COMPLETE)
...
**Task T1.3.1: LanceDB Vector Repository** (COMPLETE)
*   **Metadata:** Priority: P0 | Complexity: M | Duration: 2 days | Deps: T0.3.1 | Role: Engineer
...
**Task T1.4.1: Ingestion Service (The Pipeline)** (COMPLETE)
